export const financieras = [
  ...
  },
  {
    ...
    productos: [
      ...
      "CRÉDITO FACIL TPV (SIMPLE Y REVOLVENTE)",
      "CRÉDITO FACIL FLUJOS (SIMPLE)",
      "PROGRAMA IMPULSO + ESTADOS (SIMPLE)",
      "CRÉDITO TOTAL (SIMPLE Y REVOLVENTE)",
      "CRÉDITO INMUEBLES (SIMPLE)"
    ],
