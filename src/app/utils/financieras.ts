export const financieras = [
  {
    ...
    fase: "1",
    productos: [
      "CRÉDITO REVOLVENTE PF",
      "CRÉDITO SIMPLE (SIN GARANTÍA) PF",
      "CRÉDITO REVOLVENTE PM",
      "CRÉDITO SIMPLE (SIN GARANTÍA) PM"
    ],
  ...
  },
  {
    ...
    productos: [
      "CREDITO SIMPLE REVOLVENTE CON GARANTIA PM",
      "CREDITO PARAMETRICO",
      "ARRENDAMIENTO PURO SYLB PM",
      "CREDITO SIMPLE REVOLVENTE CON GARANTIA PFAE",
      "ARRENDAMIENTO PURO SYLB PFAE"
    ],
  ...
  },
  {
    ...
    proceso: "link",
    fase: "2",
    productos: ["ARRENDAMIENTO EQUIPO NUEVO", "ARRENDAMIENTO PURO Y FINANCIERO"],
  ...
  },
  {
    ...
    proceso: "mail",
    fase: "2",
    productos: ["ADQUISICION PYME (CRÉDITO SIMPLE)", "LIQUIDEZ PYME"],
    descripcion: "Activos productivos / Transporte / Maquinaria / Cómputo / Equipo especializado / Mobiliario",
    img: "assets/bx+.png"
  },
  {
